...
for config in "${configs[@]}"; do
    ctl job run --command "cd nl_pref/robosuite-benchmark/ && export PYTHONPATH=.:$PYTHONPATH && python scripts/train.py --variant training_configs/LiftModded-Jaco-OSC-POSITION-SEED251/diverse-rewards/$config/variant.json --seed 251" \
