...
for config in "${configs[@]}"; do
    ctl job run --name "jtien-$config-job" --command "bash -c cd nl_pref/robosuite-benchmark/ && python scripts/train.py --variant training_configs/LiftModded-Jaco-OSC-POSITION-SEED251/diverse-rewards/$config/variant.json --seed 251 --log_dir ../log/runs/diverse-rewards/$config/" \
