...
for bert_input in batches:
    ...
    for i in range(len(bert_output)):
        bert_output_words = bert_output[i]['features']  # bert_outputs[i]['features']
    ...
    np.save('/home/jeremy/robosuite-benchmark/data/nl-traj/all-pairs/nlcomps.npy',
            np.asarray(bert_output_embeddings))
